...
export default function ProductHeader({
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      scrollTimeout.current = setTimeout(() => {
        ...
        const currentlyCompact = isCompactRef.current;

        if (!currentlyCompact && currentScrollTop > COMPACT_THRESHOLD) {
          isCompactRef.current = true;
          setIsHeaderCompact(true);
        } else if (currentlyCompact && currentScrollTop < DECOMPACT_THRESHOLD) {
    ...
    if (scrollElement.scrollTop > COMPACT_THRESHOLD) {
      isCompactRef.current = true;
      setIsHeaderCompact(true);
    }
  ...
  const isNameEditable = status !== 'published' && status !== 'pending_approval';
